        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center pt-24 px-4">
            ...
            >
              ...
              breakthrough engineering bring deep-space exploration within reach&mdash;secure and
              extraordinary.
            </motion.p>
            ...
            {/* Stats */}
            <motion.div {...enter(1.3)} className="flex flex-wrap justify-center items-stretch gap-4 mt-8">
