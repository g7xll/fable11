# dot. — Nokia Typing Hero

A single-screen React landing page for "dot.", a calm-messaging product. The hero fills the viewport with a full-bleed background video of a Nokia-style phone, and a live typewriter animation — rendered in an authentic Nokia Cellphone FC font — is layered precisely over the in-video phone screen, cycling through short messages ("Are you here?", "Yes, I am.", "Speak soon.").
