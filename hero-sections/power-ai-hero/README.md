...
A full-screen dark hero for a fictional AI talent-acquisition platform. A looping
CloudFront background video fades in and out via a custom requestAnimationFrame
loop, a giant 220px **Power AI** General Sans headline carries an
indigo → purple → amber gradient, and a liquid-glass logo marquee scrolls along
the bottom.
