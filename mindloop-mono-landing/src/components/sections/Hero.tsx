  ...
  return (
    <section id="home" className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex w-full flex-col items-center px-6 pt-28 text-center md:pt-32">
        ...
        >
          Get <em className="font-serif font-normal italic">Inspired</em> with Us
        </motion.h1>
        ...
        >
          Join our feed for meaningful updates, news around technology and a shared
          journey toward depth and direction.
        </motion.p>
