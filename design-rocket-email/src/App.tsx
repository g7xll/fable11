...
const VIDEOS = {
  hero: 'https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260419_064822_f120e48a-d545-45dd-a02d-facb07829888.mp4',
  transform:
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center text-center px-6 pt-12 pb-10">
        <div className="text-white">
          ...
          <p className="text-[13px] tracking-[0.22em] font-medium mt-1">CERTIFICATES</p>
        </div>
    ...
    <section>
      ...
      <div className="px-[78px] pb-8">
        <p className="text-center text-[18px] leading-[1.55]">
          ...
          playbook for pilot proposals, data strategy and governance. Use it to help
          secure buy-in, guide rollout, and scale adoption responsibly.
        </p>
      </div>
      <div className="flex justify-center pb-14">
