...
function TogglePill({ active, inactive }: { active: string; inactive: string }) {
  return (
    <div className="flex rounded-full bg-neutral-100 p-1 text-[12px] font-medium">
      <button type="button" className="flex-1 rounded-full bg-white px-3 py-1.5 text-neutral-900 shadow">
        {active}
      </button>
      <button type="button" className="flex-1 rounded-full px-3 py-1.5 text-neutral-500">
        {inactive}
      </button>
    </div>
  )
...
function TargetInput({ label, defaultValue }: { label: string; defaultValue: string }) {
  const id = useId()
  return (
    <div>
...
function ClicksCard() {
  return (
    <div className="flex flex-col rounded-2xl bg-white p-5">
      ...
      <p className="mt-4 text-center text-[12px] text-neutral-600">Month Target achieved</p>
      <div className="mt-1">
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl bg-white p-5">
      ...
      <div className="mt-auto flex items-center gap-4 pt-1">
        ...
        <button type="button" className="text-[13px] text-neutral-700 underline underline-offset-2">
          Cancel
        </button>
        <button type="button" className="ml-auto p-1 text-neutral-500 hover:text-neutral-800" aria-label="Close">
