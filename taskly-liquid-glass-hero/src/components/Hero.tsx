...
function Star() {
  return (
    <svg data-star width="15" height="15" viewBox="0 0 20 20" fill="#FF801E" aria-hidden="true">
      ...
      <div className="pt-2 lg:py-24">
        ...
        >
          ...
          <span className="text-[14px] font-medium tracking-[-0.2px] text-slate-700">
            Rated <strong className="font-semibold text-[#0B1526]">4.9/5</strong> by 2700+ customers
          </span>
        </div>
        ...
        >
          Effortlessly manage your projects, collaborate with your team, and achieve your goals with
          our intuitive task management tool.
        </p>
