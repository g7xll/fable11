...
export default function Navbar() {
  return (
    ...
    >
      {/* Brand */}
      <a href="#" className="mr-2 flex items-center gap-2 pl-1 pr-2" aria-label="Taskly home">
        <svg width="26" height="26" viewBox="0 0 32 32" aria-hidden="true">
          ...
          />
          <defs>
            <linearGradient id="tasklyShine" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="white" stopOpacity="0.45" />
              <stop offset="0.5" stopColor="white" stopOpacity="0" />
            </linearGradient>
          </defs>
        </svg>
        <span className="font-fustat text-[21px] font-bold tracking-[-0.5px] text-[#0B1526]">Taskly</span>
      </a>
