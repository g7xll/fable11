...
const ICONS = {
  ...
  about: '<path d="M8 9h8"></path><path d="M8 13h6"></path><path d="M9 18h-3a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-3l-3 3l-3 -3z"></path>',
  projects: '<path d="M3 9a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9z"></path><path d="M8 7v-2a2 2 0 0 1 2 -2h4a2 2 0 0 1 2 2v2"></path>',
  articles: '<path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path><path d="M7 8h10"></path><path d="M7 12h10"></path><path d="M7 16h10"></path>',
  contact: '<path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"></path><path d="M3 7l9 6l9 -6"></path>',
  ...
  linkedin: '<path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M8 11l0 5"></path><path d="M8 8l0 .01"></path><path d="M12 16l0 -5"></path><path d="M16 16v-3a2 2 0 0 0 -4 0"></path>',
  youtube: '<path d="M2 8a4 4 0 0 1 4 -4h12a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-12a4 4 0 0 1 -4 -4v-8z"></path><path d="M10 9l5 3l-5 3z"></path>',
  toggle: '<path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M15 4v16"></path><path d="M9 10l2 2l-2 2"></path>',
};
...
const SOCIALS = [
  ...
  { href: "https://linkedin.com/in/manuarora28", key: "linkedin", label: "LinkedIn" },
...
function mountChrome(active, base) {
  ...
  if (cards.length) {
    ...
    cards.forEach((c, i) => { c.dataset.idx = i; io.observe(c); });
    // safety net: if anything is still hidden shortly after load, reveal it
    setTimeout(() => cards.forEach((c, i) => { if (!c.classList.contains("in")) reveal(c, i); }), 800);
  }
  ...
  document.querySelectorAll(".codeblock__copy").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (label) { const t = label.textContent; label.textContent = "Copied!"; setTimeout(() => (label.textContent = t), 1500); }
    });
  });
