...
(function () {
  ...
  function setTheme(t) {
    ...
    try { localStorage.setItem("plasma-theme", t); } catch (e) {}
  }
  ...
  // Mobile menu
  document.addEventListener("click", function (e) {
    if (e.target.closest("[data-mobile-open]")) document.querySelector(".mobile-menu").classList.add("open");
    if (e.target.closest("[data-mobile-close]")) document.querySelector(".mobile-menu").classList.remove("open");
  });
  ...
  document.querySelectorAll("[data-tabs]").forEach(function (group) {
    ...
    triggers.forEach(function (tr) {
      tr.addEventListener("click", function () {
        ...
        triggers.forEach(function (x) { x.classList.toggle("active", x === tr); });
