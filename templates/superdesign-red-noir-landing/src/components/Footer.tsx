  ...
  return (
    <footer className="bg-black border-t border-zinc-900 pt-20 pb-10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-24 relative z-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-bold font-manrope tracking-tight">Superdesign</span>
          </div>
          <p className="text-zinc-500 max-w-xs leading-relaxed">Pioneering the future of digital product design with artificial intelligence and human-centered design principles.</p>
        </div>
        <div>
      ...
      <div className="flex justify-center items-center py-10 opacity-20 pointer-events-none">
        <h1 className="text-[15vw] leading-none font-bold font-manrope tracking-tighter text-stroke select-none">SUPERDESIGN</h1>
      </div>
