...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    price: '49',
    features: ['Unlimited Projects', 'Advanced AI Models', 'Direct Code Export', 'Priority Support'],
    cta: 'Go Pro',
    featured: true,
  },
  {
    ...
    price: '199',
    features: ['Team Collaboration', 'Custom Design Systems', 'API Access & SSO'],
    cta: 'Contact Sales',
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TIERS.map((t) => (
            ...
            >
              ...
              <p className={`${t.featured ? 'text-zinc-400' : 'text-zinc-500'} text-sm mb-8 h-10`}>{t.desc}</p>
