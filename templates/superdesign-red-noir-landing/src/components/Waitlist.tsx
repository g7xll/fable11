		...
		<section className="py-32 px-6 text-center bg-zinc-950/40">
			<div className="max-w-3xl mx-auto">
				...
				<p className="text-xl text-zinc-400 mb-12">
					Join the waitlist today and get early access to the next generation of
					design tools.
				</p>
				<form
				...
				>
					...
					<button
						type="submit"
						className="bg-[#ef233c] hover:bg-red-700 text-white font-bold rounded-full px-8 py-4 transition-all"
					>
						Join Now
					</button>
				</form>
