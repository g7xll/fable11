    ...
    <section className="py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 text-center max-w-3xl mx-auto animate-fade-up">
          ...
          <p className="text-lg text-zinc-400 font-light">Replace your fragmented toolset with one cohesive platform driven by AI.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto lg:h-[700px]">
          ...
          <div className="lg:col-span-2 lg:row-span-2 group relative overflow-hidden p-8 border border-white/10 bg-gradient-to-b from-zinc-900/50 to-black hover:border-white/20 transition-all rounded-xl">
            <div className="relative z-10 h-full flex flex-col">
              ...
              <h3 className="text-3xl font-semibold text-white font-manrope mb-4 tracking-tight">Generative UI Systems</h3>
              <p className="text-zinc-400 text-lg leading-relaxed">Instantly generate comprehensive design systems from a single prompt. Colors, typography, and components are automatically created and documented with industry standards in mind.</p>
          ...
          <div className="lg:col-span-2 group relative overflow-hidden p-8 border border-white/10 bg-black hover:border-white/20 transition-all rounded-xl">
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h3 className="text-2xl font-semibold text-white font-manrope mb-2">Code Export</h3>
              <p className="text-zinc-400">Production-ready React &amp; Tailwind code, shipped directly to your repo with zero friction.</p>
            </div>
          ...
          <div className="group relative overflow-hidden p-8 border border-white/10 bg-black hover:border-white/20 transition-all rounded-xl">
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold text-white font-manrope mb-2">Smart Iteration</h3>
              <p className="text-sm text-zinc-400">A/B test variations generated by AI based on real user data.</p>
            </div>
          </div>
          {/* Team Sync */}
          <div className="group relative overflow-hidden p-8 border border-white/10 bg-black hover:border-white/20 transition-all rounded-xl">
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold text-white font-manrope mb-2">Team Sync</h3>
              <p className="text-sm text-zinc-400">Real-time collaboration with automated version control.</p>
            </div>
          </div>
        </div>
      </div>
