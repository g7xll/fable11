        ...
        >
          ...
          {CARDS.map((card, i) => (
            <motion.div
              ...
              initial={{ opacity: 0, scale: 0.95 }}
              animate={gridInView ? { opacity: 1, scale: 1 } : {}}
              transition={{ delay: (i + 1) * 0.15, duration: 0.7, ease: CARD_EASE }}
            ...
            >
              ...
              />
              <h3 className="mt-5 text-lg sm:mt-6 sm:text-xl" style={{ color: '#E1E0CC' }}>
                {card.title}{' '}
                <sup className="text-[10px] text-gray-500 sm:text-xs">({card.number})</sup>
              </h3>
