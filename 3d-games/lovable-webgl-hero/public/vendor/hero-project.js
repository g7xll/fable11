window._heroProjectData = {
			...
			data: {
				uniforms: {
					artboardResolution: {
						...
						type: "2f",
						value: { type: "Vec2", _x: 1920, _y: 1080 },
					},
					aspectRatio: {
						name: "uAspectRatio",
						type: "1f",
				...
				passes: [
					{
						...
						value: 1,
						downSample: 0.25,
						passDescription: "Blur the image along the secondary axis.",
					},
					{
						prop: "vertical",
						value: 2,
						downSample: 0.5,
						passDescription:
							"Blur the image along the primary axis at a larger scale.",
					},
					{
						prop: "vertical",
						value: 3,
						downSample: 0.5,
						passDescription:
							"Blur the image along the secondary axis and add final debanding.",
					},
				],
			},
			id: "blur",
	...
	version: "2.1.9",
	id: "T3vDuAoQmW3LNJohObF6",
};
window._heroProjectData = window._heroProjectData || {};
window._heroProjectData = _heroProjectData;
