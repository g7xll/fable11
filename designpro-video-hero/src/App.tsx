      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 pt-6 sm:px-6 md:pt-8 lg:px-8">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
            <motion.p {...fadeUp(0.15)} className="max-w-md text-sm text-white/80 md:text-base">
            ...
            <motion.p {...fadeUp(0.25)} className="text-sm text-white/80 md:text-base lg:text-right">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="mx-auto w-full max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 className="mt-4 text-5xl leading-[0.85] tracking-tighter sm:text-6xl md:mt-6 md:text-7xl lg:text-8xl xl:text-9xl">
              <motion.span {...fadeUp(0.45)} className="block font-medium text-white">
                Become
              </motion.span>
            ...
            <motion.div {...fadeUp(0.7)} className="mt-10 flex justify-center md:mt-14">
              <a
                href="#"
