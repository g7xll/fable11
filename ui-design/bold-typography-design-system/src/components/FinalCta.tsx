...
export function FinalCta() {
	...
	return (
		<section
			id="final-cta"
			className="theme-invert relative overflow-hidden bg-background py-24 md:py-32 lg:py-40"
		>
			...
			<div className="container-bold relative">
				...
				<h2 className="mt-8 max-w-[12ch] text-5xl font-extrabold leading-[0.95] tracking-tighter text-foreground sm:text-7xl md:text-8xl">
					{finalCta.headline.map((line, i) => (
						<span
							key={line}
							className={`block ${i === finalCta.headline.length - 1 ? "text-accent" : ""}`}
						>
							{line}
						</span>
					))}
				...
				<div className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-12">
					<p className="max-w-md text-lg leading-normal text-muted-foreground lg:col-span-5">
						{finalCta.body}
					</p>
