...
export function Features() {
	return (
		<section
			id="features"
			className="border-b border-border py-20 md:py-28 lg:py-32"
		>
			<div className="container-bold">
				<Reveal className="max-w-3xl">
					...
					<p className="mt-6 max-w-xl text-lg leading-normal text-muted-foreground">
						Each principle is a constraint, and the constraints are the point.
						Together they make the type do all the talking.
					</p>
				</Reveal>
