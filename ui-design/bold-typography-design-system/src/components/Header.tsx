		...
		<header className="fixed inset-x-0 top-0 z-50">
			...
			>
				<div className="container-bold flex h-16 items-center justify-between md:h-20">
					...
					>
						...
						<span
							aria-hidden
							className="h-1.5 w-1.5 bg-accent transition-transform duration-150 group-hover:scale-150"
						/>
					</a>
			...
			<AnimatePresence>
				{open && (
					...
					>
						<nav
							className="container-bold flex flex-1 flex-col justify-center gap-2 py-10"
							aria-label="Mobile"
						>
							{nav.map((item, i) => (
								<motion.a
