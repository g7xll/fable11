...
export const hero = {
	...
	lede: "Roman & Quill is a private publishing house for writers who believe a sentence deserves fine paper, generous margins, and an unhurried reader. We set, bind, and circulate work made to be kept.",
...
export const features = [
	{
		...
		body: "Every manuscript is set in Playfair Display and read aloud before it is bound. Kerning is corrected by eye, widows are chased from the page, and nothing leaves the room until the rhythm is right.",
		plate: "specimen" as const,
	},
	{
		kicker: "II.",
		title: "Printed to last",
		body: "We commit each title to cotton-rag, acid-free stock with a deckle edge. Gilt is applied sparingly — a single thread of gold leaf where the eye should rest, never more.",
		plate: "letter" as const,
	},
	{
		kicker: "III.",
		title: "Circulated with care",
		body: "Members receive a numbered volume by post each season, wrapped in glassine and accompanied by a letter from the editor on the choices behind the issue.",
...
export const benefits = {
	...
	lede: "We resist the temptation to publish quickly. Each issue passes through the same five hands it has for nearly four decades — a reader, an editor, a compositor, a binder, and a proof.",
	points: [
		{
			title: "The reading",
	...
	marginNote: "“We have never met a deadline we preferred to a sentence.”",
...
export const pricing = {
	...
	lede: "Every membership is annual, renewable by hand, and may be passed to a friend. No tier is louder than the others — only more generous.",
	tiers: [
		{
			name: "The Reader",
			price: "$96",
