			...
			<div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.3fr_0.7fr] lg:gap-16">
				...
				<aside className="lg:sticky lg:top-28 lg:self-start">
					<div className="relative">
						<span
							aria-hidden
							className="absolute -right-4 -top-4 h-full w-full rounded-lg border border-accent/40"
						/>
					...
					<figure className="mt-10 border-l-2 border-accent pl-6">
						...
						<figcaption className="small-caps mt-4 text-muted-foreground">
							{benefits.marginAttribution}
						</figcaption>
					</figure>
				</aside>
			</div>
