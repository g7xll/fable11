...
export default function WhyChooseUs01Velara({
	className,
}: {
	className?: string;
}) {
	const features = [
		...
		},
		{
			...
			description:
				"End-to-end encryption for all transactions and data protection.",
			icon: (
				<motion.div
		...
		},
		{
			...
			description:
				"Send money internationally with fast and reliable processing.",
			icon: (
				<motion.div
					animate={{ rotate: 360 }}
					transition={{
	...
	return (
		<>
			...
			<section
				className={
					"bg-black py-20 px-6 md:px-[60px] font-['Inter',_sans-serif] relative overflow-hidden " +
					(className || "")
				}
			>
				{/* BACKGROUND ACCENTS */}
