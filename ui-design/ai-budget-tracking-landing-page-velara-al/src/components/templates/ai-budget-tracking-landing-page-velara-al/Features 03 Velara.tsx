...
export default function Features03Velara({
	className,
}: {
	className?: string;
}) {
	return (
		<>
			...
			<section
				className={
					"bg-black py-[90px] px-6 md:px-[60px] font-['Inter',_sans-serif] relative overflow-hidden " +
					(className || "")
				}
			>
				{/* BACKGROUND ACCENTS */}
						...
						<div className="w-full lg:w-[55%] relative">
							<div className="bg-[#111111] border border-[#222222] rounded-[24px] p-8 md:p-12 min-h-[480px] relative overflow-hidden group">
								...
								>
									...
									<h4 className="text-[17px] font-bold text-white mb-6">
										Transfer Tracking
									</h4>
									...
									<div className="flex items-center justify-between mb-8 relative">
										<div className="flex flex-col items-center gap-2">
											<div className="w-10 h-10 rounded-full border-2 border-white/10 p-0.5">
												<div className="w-full h-full rounded-full bg-[#A855F7] flex items-center justify-center text-[10px] font-bold text-white">
													US
												</div>
											</div>
											<span className="text-[9px] font-bold text-[#A855F7] uppercase tracking-tighter">
												Paypal
											</span>
										</div>
										...
										<div className="flex flex-col items-center gap-2">
											<div className="w-10 h-10 rounded-full border-2 border-white/10 p-0.5">
												<div className="w-full h-full rounded-full bg-[#DE2910] flex items-center justify-center text-[8px]">
													★
												</div>
											</div>
											<span className="text-[9px] font-bold text-[#A855F7] uppercase tracking-tighter">
						...
						<div className="w-full lg:w-[45%]">
							...
							>
								...
								<p className="text-[17px] text-[#777777] leading-[1.7] mb-8 font-medium">
									Managing your finances shouldn't be complicated. Our
									intelligent payment platform gives you full control over your
									money — whether you're spending locally or globally.
								</p>
								...
								<div className="space-y-4 mb-10">
									{[
										...
										<div key={i} className="flex items-center gap-4">
											...
											<span className="text-[16px] text-[#ffffff] font-semibold">
												{item}
											</span>
										</div>
									))}
