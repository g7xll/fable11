...
export default function Pricing01Velara({ className }: { className?: string }) {
	return (
		<>
			...
			<section
				className={
					"bg-black pt-[96px] pb-[160px] px-6 md:px-[60px] relative overflow-hidden " +
					(className || "")
				}
						...
						>
							<div className="flex items-center justify-between mb-[24px]">
								<div className="flex items-center gap-[12px]">
									...
									<span className="font-semibold text-[16px] text-white/90">
										Basic Plan
									</span>
								</div>
							</div>
							...
							<div className="mb-[14px]">
								<span className="text-[48px] md:text-[56px] font-medium text-white tracking-tight">
									$10
								</span>
								<span className="text-[14px] text-white/40 font-medium ml-[8px]">
									per month
								</span>
							</div>
