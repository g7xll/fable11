...
export default function Features06Velara({
	className,
}: {
	className?: string;
}) {
	return (
		<>
			...
			<section
				className={
					"font-['Inter',_sans-serif] selection:bg-[#A855F7]/30 bg-black py-[96px] px-6 md:px-[60px] relative overflow-hidden " +
					(className || "")
				}
			>
					...
					<div className="mb-[60px] md:mb-[100px]">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 lg:gap-8 items-start">
							...
							>
								...
								<h3 className="font-semibold text-[17px] text-white mb-2.5 transition-colors group-hover:text-[#A855F7]">
									Bank-Level Security Encryption
								</h3>
								<p className="text-[14px] text-white/40 leading-[1.6]">
									256-bit SSL secure environment for all your sensitive
									operations.
								</p>
							</motion.div>
							...
							>
								...
								<p className="text-[14px] text-white/40 leading-[1.6]">
									We follow global level security certifications and standards.
								</p>
							</motion.div>
							...
							>
								...
								<p className="text-[14px] text-white/40 leading-[1.6]">
									Always-on protection systems monitoring every transaction.
								</p>
							</motion.div>
							...
							>
								...
								<p className="text-[14px] text-white/40 leading-[1.6]">
									Your deposits are covered up to $6000 for peace of mind.
								</p>
							</motion.div>
						</div>
					</div>
						...
						>
							...
							<div className="flex-1 p-[40px] md:p-[60px] lg:p-[80px] flex flex-col justify-center relative z-20">
								...
								<p className="text-[16px] text-white/40 leading-[1.6] max-w-[400px] mb-10">
									Fintech is available across all your favorite devices. Access
									anytime on mobile or web.
								</p>
								...
								<div className="flex flex-wrap gap-[16px]">
									...
									<button className="bg-[#1c1c1e] border border-[#333333] rounded-[16px] p-[14px_28px] inline-flex items-center gap-[14px] hover:bg-[#2a2a2a] transition-all hover:scale-[1.05] hover:border-[#A855F7]/30 group/btn">
										...
										<div className="text-left">
											<p className="text-[11px] text-white/40 leading-none mb-1 uppercase tracking-wider font-bold">
												Download on
											</p>
								...
								<div className="absolute right-[-40px] top-[60px] w-[640px] bg-[#1a1a1a] rounded-[20px_20px_0_0] border border-[#2a2a2a] overflow-hidden z-10 transition-transform duration-1000 group-hover:translate-x-[-10px] group-hover:translate-y-[-10px]">
									...
									<div className="bg-[#141414] h-[40px] border-b border-[#2a2a2a] px-5 flex items-center gap-3">
										...
										<span className="text-[13px] text-white/60 font-semibold flex items-center gap-1.5 ml-6">
											<span className="text-[#A855F7] text-[18px]">
												&#x2B21;
											</span>{" "}
											Finflow
										</span>
									...
									<div className="flex h-[380px]">
										<div className="w-[120px] bg-[#111111] border-r border-[#1e1e1e] py-6 flex flex-col gap-1">
											{[
												...
												<div
													key={i}
													className={
														"p-[10px_20px] text-[10px] font-bold uppercase tracking-widest " +
														(i === 0
										...
										<div className="flex-1 bg-[#141414] p-6 flex flex-col gap-6">
											<div className="flex justify-between items-end">
												<div>
													<p className="text-[13px] font-bold text-white/80 mb-1">
														Expenses Summary
													</p>
													<p className="text-[9px] text-white/20 tracking-widest uppercase font-bold">
														Real-time Analytics
													</p>
												</div>
												<div className="text-[20px] font-bold text-[#A855F7]">
													$142,390
												</div>
											</div>
											<div className="relative h-[120px] w-full">
												...
												>
													...
													/>
													<path
														d="M0 80 C30 75 50 60 80 50 C110 40 130 65 160 55 C190 45 210 30 240 25 C270 20 290 40 320 35 C350 30 370 45 400 40 L400 100 L0 100Z"
														fill="rgba(168,85,247,0.06)"
													/>
													<path
														d="M0 80 C30 75 50 60 80 50 C110 40 130 65 160 55 C190 45 210 30 240 25 C270 20 290 40 320 35 C350 30 370 45 400 40"
														stroke="#A855F7"
														strokeWidth="2.5"
														fill="none"
														strokeLinecap="round"
											...
											<div className="grid grid-cols-2 gap-4 mt-2">
												<div className="bg-white/5 rounded-xl p-4 border border-white/5">
													<p className="text-[10px] text-white/30 uppercase font-black mb-1">
														Mutual Funds
													</p>
