			...
			<Shell>
				<Reveal className="mx-auto max-w-2xl text-center">
					...
					<h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl">
						One surface for your{" "}
						<span className="text-gradient">entire operation</span>
					</h2>
					<p className="mx-auto mt-5 max-w-xl text-lg text-slate-500">
						Stop stitching together scripts, spreadsheets, and a dozen
						disconnected tools. Northwind brings the whole workflow into one
						trusted, observable place.
					</p>
				</Reveal>
