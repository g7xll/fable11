...
import featureUi1 from "../../../../assets/svg/P01-Feature-UI-01.svg";
import featureUi2 from "../../../../assets/svg/P01-Feature-UI-02.svg";
import featureUi3 from "../../../../assets/svg/P01-Feature-UI-03.svg";
import featureUi4 from "../../../../assets/svg/P01-Feature-UI-04.svg";
...
function FeatureCard({
	...
	return (
		<motion.div
			...
			className={
				"flex flex-col items-start shrink-0 border border-[#042718]/10 overflow-hidden bg-white group w-full rounded-[24px] sm:rounded-[32px] " +
				(className || "")
			}
		>
...
export default function OriginaFinsycFeature({
	...
	const cards: Array<{
	...
	}> = [
		{
			...
			description:
				"Automatically categorize every transaction and see where your money really goes with AI.",
			icon: PieChart,
			uiSrc: featureUi1,
			width: "676px",
		},
		{
			...
			description:
				"Stay ahead of your bills and know your balance before the month starts.",
			icon: BarChart3,
			uiSrc: featureUi2,
			width: "548px",
		},
		{
			...
			description:
				"Your data is encrypted with military-grade protocols and never stored on our servers.",
			icon: Shield,
			uiSrc: featureUi3,
			width: "548px",
		},
		{
			...
			description:
				"Send money to anyone, anywhere, instantly with zero hidden fees or processing delays.",
			icon: Zap,
			uiSrc: featureUi4,
			width: "676px",
		},
				...
				<div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-center">
							...
							>
								Everything you need to take control of your financial future in
								one simple, powerful application.
							</motion.p>
						</div>
