	...
	return (
		...
		>
			...
			<div className="relative z-10 w-full flex flex-col">
				...
				<div
					className={
						"mt-[16px] border-t w-full transition-colors duration-300 " +
						(isVisualActive ? "border-[#042718]/20" : "border-[#042718]/08")
					}
				/>
				...
				<button
					...
					className={
						...
						(isBtnHovered || isVisualActive
							? "bg-[#042718] border-[#042718] text-white"
							: "bg-white border-[#042718]/10 text-[#042718]") +
						" " +
						(isBtnHovered
							? "p-[8px_20px_8px_8px] flex-row-reverse"
							: "p-[8px_8px_8px_20px] flex-row")
					}
				>
					<motion.span
						layout
							...
							<li key={idx} className="flex items-start gap-3">
								...
								>
									<Check
										...
										strokeWidth={3.5}
										className={
											isVisualActive ? "text-[#042718]" : "text-[#15803D]"
										}
									/>
								</div>
								<span
...
export default function Pricing01Finsyc({ className }: { className?: string }) {
	...
	return (
		<>
			...
			/>
			<link
				href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Onest:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400;1,500;1,600&display=swap"
				rel="stylesheet"
			/>
			...
			<section
				id="pricing"
				className={
					"w-full bg-[#ffffff] py-20 lg:py-32 overflow-hidden flex justify-center " +
					(className || "")
				}
			>
				<div className="w-full max-w-[1248px] lg:px-0 px-6 flex flex-col items-center">
					...
					>
						Simple, transparent pricing to help you track, manage, and grow your
					...
					<div className="flex flex-col lg:flex-row gap-6 w-full justify-center">
						{plans.map((plan: PricingPlan, idx: number) => {
							const isVisualActive = hoveredPlan
