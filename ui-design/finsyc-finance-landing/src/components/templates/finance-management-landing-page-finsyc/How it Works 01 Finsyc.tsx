...
import processImg from "../../../../assets/svg/P01-Process-img.svg";
...
const steps: ProcessStep[] = [
	{
		...
		subheading:
			"Securely link your bank accounts, cards, and wallets in seconds — and get a complete, real-time view of your finances in one place.",
		list: [
	...
	},
	{
		...
		subheading:
			"Our AI automatically categorizes your spending habits, helping you identify areas where you can save and improve your financial health.",
		list: [
	...
	},
	{
		...
		subheading:
			"Define your financial targets and let our system guide you towards achieving them with personalized recommendations and alerts.",
		list: [
	...
	},
	{
		...
		subheading:
			"Get actionable advice powered by machine learning to optimize your wealth growth and minimize unnecessary financial risks.",
		list: [
...
export default function FinsycOriginal4step({
	className,
}: {
	className?: string;
}) {
	...
	const activeStep =
		steps.find((s: ProcessStep) => s.id === activeTab) || steps[0];
					...
					<div className="flex flex-col items-start gap-12 lg:gap-16">
						...
						<div className="flex flex-col items-start">
							...
							>
								...
								<br className="block lg:hidden" /> in{" "}
