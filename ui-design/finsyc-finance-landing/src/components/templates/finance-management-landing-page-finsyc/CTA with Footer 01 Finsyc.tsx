	...
	return (
		<motion.button
			...
			className={cn(
				...
				isHovered
					? "pl-[8px] pr-[20px] flex-row-reverse"
					: "pl-[20px] pr-[8px] flex-row",
			)}
		>
			<motion.span
				layout
			...
			>
				<ArrowUpRight
					className={cn("w-4 h-4", isPrimary ? "text-[#042718]" : "text-white")}
				/>
			</motion.div>
		</motion.button>
	);
...
export default function CtaWithFooter01Finsyc({
	...
	return (
		<>
			...
			/>
			<link
				href="https://fonts.googleapis.com/css2?family=Onest:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&display=swap"
				rel="stylesheet"
			/>
					...
					<div className="max-w-[1440px] w-full mx-auto px-6 lg:px-[96px] relative z-10 flex flex-col items-center">
						<div className="max-w-[1248px] w-full flex flex-col items-center">
							...
							>
								...
								<span className="italic text-[rgba(0,0,0,0.40)]">finances</span>{" "}
								today
							</motion.h2>
							...
							>
								Track your spending, manage budgets, and make smarter financial
								decisions — all in one powerful and intuitive app.
							</motion.p>
					...
					<div className="relative z-10 w-full max-w-[1440px] px-6 lg:px-[96px] pt-[64px] pb-[32px] flex flex-col items-start bg-transparent">
						...
						>
							...
							<div className="w-full lg:w-[440px] flex flex-col gap-6">
								...
								>
									Get smarter with your money — tips, insights, and updates
							...
							<div className="lg:ml-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:flex lg:flex-nowrap gap-y-12 gap-x-8 lg:gap-[64px] w-full lg:w-auto">
								...
								<div className="lg:w-[152px] flex flex-col gap-[20px] relative">
									...
									<ul className="flex flex-col gap-[16px]">
										{["Features", "Integrations", "Pricing", "Security"].map(
											(link: string) => (
								...
								<div className="lg:w-[152px] flex flex-col gap-[20px] relative">
									...
									<ul className="flex flex-col gap-[16px]">
										{["About us", "Careers", "Blog", "Contact"].map(
											(link: string) => (
												<motion.li key={link} variants={itemVariants}>
													<a
														href="#"
						...
						>
							<div className="flex items-center gap-8 text-white font-sans text-[18px] font-normal leading-[28px] opacity-80">
								<a
									href="#"
									className="hover:opacity-100 hover:font-medium transition-all"
								>
									Terms & Conditions
								</a>
								<a
