...
import quickbooksIcon from "../../../../assets/svg/quickbooks.svg";
import xeroIcon from "../../../../assets/svg/xero.svg";
import coinbaseIcon from "../../../../assets/svg/coinbase.svg";
import finsycMark from "../../../../assets/svg/finsyc-mark.svg";
...
export default function Integration01Finsyc({
	className,
}: {
	className?: string;
}) {
	...
	return (
		<>
			...
			<section
				className={
					"w-full bg-[#F4FAFB] py-16 md:py-[100px] overflow-hidden relative flex justify-center " +
					(className || "")
				}
			>
					...
					<div className="w-full max-w-[1248px] mx-auto">
						...
						<div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
							...
							>
								...
								<span className="italic text-[rgba(0,0,0,0.40)]">
									one place
								</span>
							</motion.h2>
							...
							>
								Seamlessly integrate your bank accounts, cards, and financial
								apps to get a complete, real-time view of your finances.
							</motion.p>
						</div>
								...
								<div className="flex flex-wrap lg:grid justify-center gap-4 lg:absolute lg:left-0 lg:top-0 lg:h-full lg:w-[280px] mb-8 lg:mb-0">
									{leftIntegrations.map((item, idx) => (
										<motion.div
											...
											viewport={{ once: true }}
											className={
												"w-[240px] sm:w-[260px] lg:w-[280px] h-[72px] lg:h-[80px] bg-white rounded-[16px] lg:rounded-[20px] p-3 lg:p-[16px] flex items-center gap-3 lg:gap-4 shadow-[0_4px_20px_rgba(4,39,24,0.02)] group hover:shadow-[0_12px_40px_rgba(4,39,24,0.06)] transition-all cursor-default border border-black/[0.02] lg:absolute"
											}
											style={{
