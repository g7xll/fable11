...
// Assets vendored locally (originals on cdn.jiro.build are unreachable / hotlink-blocked).
import bgVideo from "../../../../assets/video/finsyc-bg.mp4";
import logoWithName from "../../../../assets/svg/finsyc-logo-name.svg";
import horizonLogo from "../../../../assets/svg/Horizon.svg";
import naxusLogo from "../../../../assets/svg/Naxus.svg";
import lumassaLogo from "../../../../assets/svg/Lumassa.svg";
import cyborgLogo from "../../../../assets/svg/Cyborg.svg";
import catalystLogo from "../../../../assets/svg/Catalyst.svg";
                ...
                >
                  {[...Array(2)].map((_: unknown, i: number) => (
                    <React.Fragment key={i}>
                      <img src={horizonLogo} alt="Horizon" className="h-6 sm:h-7 lg:h-9 w-auto hover:opacity-80 transition-opacity" />
                      <img src={naxusLogo} alt="Naxus" className="h-6 sm:h-7 lg:h-9 w-auto hover:opacity-80 transition-opacity" />
                      <img src={lumassaLogo} alt="Lumassa" className="h-6 sm:h-7 lg:h-9 w-auto hover:opacity-80 transition-opacity" />
                      <img src={cyborgLogo} alt="Cyborg" className="h-6 sm:h-7 lg:h-9 w-auto hover:opacity-80 transition-opacity" />
                      <img src={catalystLogo} alt="Catalyst" className="h-6 sm:h-7 lg:h-9 w-auto hover:opacity-80 transition-opacity" />
                    </React.Fragment>
                  ))}
                </motion.div>
              </div>
