			...
			>
				...
				<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 lg:pt-8 pb-12">
						...
						<div className="flex items-center gap-4">
							<motion.button
								...
								className={
									...
									(isNavHovered
										? "flex-row-reverse pl-1.5 pr-[18px]"
										: "flex-row pl-[18px] pr-1.5")
								}
							>
								<motion.span
									layout
					...
					<div className="flex flex-col items-center mt-12 lg:mt-[80px]">
						...
						>
							Automatically track your spending, predict upcoming expenses, and
							make smarter financial decisions without lifting a finger.
						</motion.p>
