...
export default function WhyChooseUs01Finsyc({
	className,
}: {
	className?: string;
}) {
	...
	const benefits: Array<{
	...
	}> = [
		{
			...
			description:
				"Get real-time visibility into your spending, income, and financial trends to make better faster.",
			icon: Lightbulb,
		},
		{
			title: "Fast and seamless tracking",
			description:
				"Automatically track all transactions across accounts without manual input or delays.",
			icon: Zap,
		},
		{
			title: "Personalized for you",
			description:
				"Customize budgets, goals, and insights based on your unique financial behavior",
			icon: User,
		},
		{
			title: "Maximum financial efficiency",
			description:
				"Reduce unnecessary expenses and optimize your cash flow with intelligent recommendations.",
			icon: TrendingUp,
		},
		{
			title: "Simple and user friendly",
			description:
				"Enjoy a clean, intuitive interface designed to make managing money easy for everyone.",
			icon: MousePointer2,
		},
		{
			title: "Advanced data security",
			description:
				"Your financial data is protected with military-grade encryption and secure protocols.",
			icon: ShieldCheck,
		},
		{
			title: "Global connectivity",
			description:
				"Sync your accounts from thousands of financial institutions around the world instantly.",
			icon: Globe,
		},
		{
			title: "Customized analytics",
			description:
				"Create deep-dive reports and visualizations that matter most to your financial goals.",
			icon: PieChart,
		},
		{
			title: "Instant smart alerts",
			description:
				"Stay ahead with real-time notifications about unusual spending or budget limits.",
			icon: Bell,
		},
		{
			title: "Collaborative finance",
			description:
				"Share budgets and track goals with family members or business partners seamlessly.",
			icon: Users,
		},
	];
	...
	return (
		<>
			...
			<section
				className={cn(
					"w-full bg-white py-16 md:py-24 lg:py-[120px] flex justify-center",
					className,
				)}
			>
						...
						<div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-[48px] justify-between">
							...
							<div className="w-full lg:max-w-[622px] flex flex-col items-start lg:sticky lg:top-[120px] self-start">
								...
								>
									...
									<span className="text-[#138E5F] font-sans text-sm font-medium">
										Benefits
									</span>
								</motion.div>
								...
								>
									Take full control of your financial growth with{" "}
									<i className="text-[rgba(0,0,0,0.40)]">intelligent</i> tools
								</motion.h2>
								...
								>
									Manage your money smarter with powerful tools designed to
									simplify tracking, optimize spending, and drive better
									financial decisions.
								</motion.p>
