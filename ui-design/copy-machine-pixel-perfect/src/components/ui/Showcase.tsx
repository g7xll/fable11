...
const LAYERS: {
  ...
  { key: "all", name: "Assembled", designator: "ASM", note: "All layers composited as the fab sees it." },
  { key: "copper", name: "Top copper", designator: "L1", note: "Signal traces, pours, and pads on layer 1." },
  { key: "mask", name: "Solder mask", designator: "SM", note: "The green coat — openings expose pads only." },
  { key: "silk", name: "Silkscreen", designator: "SK", note: "Reference designators and part outlines." },
];
                  ...
                  <span className="flex-1">
                    <span
                      className={cn(
                        ...
                        selected ? "text-silk" : "text-silk-dim group-hover:text-silk",
                      )}
                    >
                      {layer.name}
                    </span>
