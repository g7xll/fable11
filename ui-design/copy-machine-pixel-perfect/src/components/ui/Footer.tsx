...
const COLUMNS: { heading: string; links: string[] }[] = [
  {
    heading: "Studio",
    links: ["Schematic editor", "Layout & routing", "DRC engine", "Signal integrity", "Component library"],
  },
  {
    heading: "Manufacturing",
    links: ["Gerber export", "Assembly ordering", "Fab partners", "Stack-up builder", "BOM tools"],
  },
  {
    heading: "Company",
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-5">
          ...
          <div className="col-span-2">
            <a href="#top" className="flex items-center gap-2.5" aria-label="Foundry home">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-substrate-600/60 pt-6 sm:flex-row">
          ...
          <div className="flex items-center gap-5 font-mono text-[11px] text-silk-faint">
            <a href="#cta" className="transition-colors hover:text-silk-dim">Privacy</a>
            <a href="#cta" className="transition-colors hover:text-silk-dim">Terms</a>
            <a href="#cta" className="transition-colors hover:text-silk-dim">Security</a>
          </div>
        </div>
      </div>
    </footer>
