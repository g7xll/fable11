...
const TRACES: { d: string; delay: number; color: string }[] = [
  ...
  { d: "M1200 110 H1020 L940 190 H700 L640 250 H300", delay: 0.4, color: "#C97A2B" },
  { d: "M0 360 H140 L220 280 H460 L520 340 H780 L860 260 H1200", delay: 0.2, color: "#E8A24B" },
  { d: "M1200 420 H960 L880 500 H560 L500 560 H160", delay: 0.7, color: "#3DD6D0" },
  { d: "M0 600 H260 L340 520 H600 L680 600 H1200", delay: 0.55, color: "#C97A2B" },
      ...
      >
        ...
        {VIAS.map((v, i) => (
          <circle
            ...
            style={{ transformOrigin: `${v.x}px ${v.y}px`, animationDelay: `${i * 0.5}s` }}
          />
        ))}
      </svg>
    </div>
