...
await must(
	"nav brand 'Aperture' present",
	async () => (await page.locator("header >> text=Aperture").count()) > 0,
);
await must(
...
await must(
	"section #features",
	async () => await page.locator("#features").isVisible(),
);
await must(
	"section #workflow",
	async () => (await page.locator("#workflow").count()) > 0,
);
await must(
	"section #pricing",
	async () => (await page.locator("#pricing").count()) > 0,
);
await must(
	"featured pricing badge 'Most loved'",
	async () => (await page.locator("text=Most loved").count()) > 0,
);
await must(
	"section #testimonials",
	async () => (await page.locator("#testimonials").count()) > 0,
);
await must(
	"FAQ accordion buttons",
	async () => (await page.locator("#faq button[aria-expanded]").count()) >= 5,
);
await must(
	"footer copyright",
	async () => (await page.locator("footer >> text=Aperture Labs").count()) > 0,
);
