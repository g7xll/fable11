...
export default function Hero() {
  return (
    ...
    >
      ...
      <div data-testid="vignette" className="vignette absolute inset-0 z-10" aria-hidden="true" />
      ...
      <div className="absolute inset-x-0 bottom-0 z-30 mx-auto w-full max-w-[1640px] px-6 pb-28 md:px-12 md:pb-36">
        ...
        <h1 className="mt-6 font-display leading-[0.94] tracking-[0.015em]">
          <span className="mask-line text-[clamp(3.4rem,10.5vw,9.75rem)]" style={{ animationDelay: "0.95s" }}>
            <span>Darkness,</span>
          </span>
          <span className="mask-line text-[clamp(3.4rem,10.5vw,9.75rem)]" style={{ animationDelay: "1.12s" }}>
            <span>
