  ...
  return (
    ...
    >
      ...
      >
        ...
        <ellipse cx="480" cy="225" rx="380" ry="120" fill="#11362a" filter="url(#glow-blur)" />
        <ellipse cx="480" cy="215" rx="245" ry="74" fill="#1d5f49" opacity="0.8" filter="url(#glow-blur)" />
        <ellipse cx="480" cy="208" rx="132" ry="42" fill="#2dd4bf" opacity="0.4" filter="url(#glow-blur)" />
      </svg>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col items-center justify-center px-6 pb-24 pt-40 text-center md:pt-44">
        ...
        >
          Master in-demand coding skills with project-first courses, weekly
          code reviews, and 1:1 mentorship from engineers shipping at the
