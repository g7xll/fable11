...
export default function Telemetry({ stats, muted, onToggleMute }) {
  ...
  return (
    <aside className="telemetry reveal" style={{ '--reveal-order': 7 }} aria-label="Live stream telemetry">
        ...
        >
          {muted ? (
            <svg viewBox="0 0 16 16" aria-hidden="true">
              ...
              <path d="m11 6 4 4m0-4-4 4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
            </svg>
          ) : (
            <svg viewBox="0 0 16 16" aria-hidden="true">
              <path d="M2.5 6v4h2.7L9 13V3L5.2 6H2.5Z" fill="currentColor" />
              <path d="M11 5.5a3.6 3.6 0 0 1 0 5m1.6-7a6 6 0 0 1 0 9" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
            </svg>
          )}
        </button>
      </header>
