    ...
    btns.forEach(function (b) {
      b.addEventListener('click', function () {
        ...
        amts.forEach(function (a) {
          a.textContent = annual ? a.getAttribute('data-annual') : a.getAttribute('data-monthly');
        });
        document.querySelectorAll('.per').forEach(function (p) {
          if (p.getAttribute('data-per')) p.textContent = annual ? '/ mo, billed yearly' : p.getAttribute('data-per');
        });
      });
    });
  }
