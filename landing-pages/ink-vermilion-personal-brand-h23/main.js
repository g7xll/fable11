(function () {
  ...
  if (reduce || !("IntersectionObserver" in window)) {
    ...
    var io = new IntersectionObserver(function (entries) {
      entries.forEach(function (e, i) {
        if (e.isIntersecting) {
          var t = e.target;
          setTimeout(function () { t.classList.add("visible"); }, (i % 4) * 80);
          io.unobserve(t);
        }
      });
  ...
  wireForm(document.getElementById("heroForm"), { sending: "Sending…", done: "Thank you ✓", note: true });
  wireForm(document.getElementById("newsForm"), { sending: "…", done: "Subscribed ✓" });
})();
