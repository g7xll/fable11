# Vermillion Table — Premium Food-Delivery Landing Page

A warm, editorial landing page for **Vermillion Table**, a fictional high-end food-delivery service ("Taste Beyond Boundaries"). The named aesthetic identity is **"Culinary Architecture"** — food delivery treated as a design object: pale vanilla-paper backgrounds, rounded modular "island" cards, oversized ultra-tight display type in Questrial, and a confident red-orange / deep-teal duotone. The feel is a neighborhood atelier menu crossed with a Swiss design magazine.
