(function () {
  ...
  function showDay(n) {
    ...
    on.querySelectorAll('.reveal').forEach(function (el) { el.classList.add('visible'); });
  }

  if (btn1 && btn2) {
    btn1.addEventListener('click', function () { showDay(1); });
    btn2.addEventListener('click', function () { showDay(2); });
  }
