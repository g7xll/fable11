...
(function () {
  ...
  if (reduced) {
    Array.prototype.slice.call(document.querySelectorAll("[data-count]")).forEach(animateCount);
  }
  ...
  window.addEventListener("scroll", function () {
    ...
    if (on !== lastShadow) {
      ...
      header.style.borderBottom = on ? "1px solid rgba(7,14,1,0.08)" : "1px solid transparent";
      lastShadow = on;
    }
  }, { passive: true });
})();
