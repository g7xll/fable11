...
export default function HeroAsciiOne() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 h-full w-full stars-bg" aria-hidden></div>
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              ...
              <button className="relative flex items-center justify-center gap-2 px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200 group" style={{ borderWidth: "1px" }}>
                EMBRACE THE JOURNEY
                <ArrowUpRight className="h-3.5 w-3.5 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" strokeWidth={1.75} />
              </button>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:gap-4 text-[8px] lg:text-[9px] font-mono text-white/50">
            <span className="hidden lg:flex items-center gap-1">
              <LoaderCircle className="h-2.5 w-2.5 animate-spin" strokeWidth={2} />
              RENDERING
            </span>
