 ...
 * This is the "drop the component in and wire five sliders" reference usage.
 * The richer instrument console lives in `App.tsx`; this file is kept so the
 * canonical demo from the prompt stays available and self-documenting.
 */
