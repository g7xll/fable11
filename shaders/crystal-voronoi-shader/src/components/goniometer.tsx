  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" className="h-full w-full opacity-[0.55]">
        ...
        {/* Crosshair */}
        <line x1="100" y1="40" x2="100" y2="48" stroke="rgba(82,224,207,0.7)" strokeWidth="0.6" />
        <line x1="100" y1="152" x2="100" y2="160" stroke="rgba(82,224,207,0.7)" strokeWidth="0.6" />
        <line x1="40" y1="100" x2="48" y2="100" stroke="rgba(82,224,207,0.7)" strokeWidth="0.6" />
        <line x1="152" y1="100" x2="160" y2="100" stroke="rgba(82,224,207,0.7)" strokeWidth="0.6" />
      </svg>
    </div>
  );
}
