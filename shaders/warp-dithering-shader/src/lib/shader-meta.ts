...
export const SHAPES: ShapeInfo[] = [
  {
    ...
    uniform: 2,
    label: "Warp",
    blurb: "Five folded cosine iterations bend the plane into flowing caustic bands.",
  },
  {
    id: "simplex",
    uniform: 1,
...
export const TYPES: TypeInfo[] = [
  {
    ...
    uniform: 1,
    label: "Random",
    blurb: "White-noise threshold from a hash — grainy, film-like, never repeats.",
    matrix: null,
    size: 0,
  },
  {
  ...
  },
  {
    ...
    uniform: 3,
    label: "Bayer 4×4",
    blurb: "Sixteen-step ordered dither — the demo default. Crisp print-like texture.",
    matrix: BAYER_4,
    size: 4,
  },
  {
    ...
    uniform: 4,
    label: "Bayer 8×8",
    blurb: "Sixty-four-step ordered dither — the smoothest, finest gradient ramp.",
    matrix: BAYER_8,
    size: 8,
  },
];
...
export const PROP_SPECS: PropSpec[] = [
  { name: "shape", type: "DitheringShape", fallback: '"simplex"', uniform: "u_shape", note: "Which procedural field to render (7 options)." },
  { name: "type", type: "DitheringType", fallback: '"8x8"', uniform: "u_type", note: "Dithering kernel: random or Bayer 2×2 / 4×4 / 8×8." },
  { name: "colorBack", type: "string (hex)", fallback: '"#000000"', uniform: "u_colorBack", note: "Background colour for the 0-bit." },
  { name: "colorFront", type: "string (hex)", fallback: '"#ffffff"', uniform: "u_colorFront", note: "Foreground colour for the lit 1-bit." },
  { name: "pxSize", type: "number", fallback: "4", uniform: "u_pxSize", note: "Pixelisation cell size — the chunkiness of the grid." },
  { name: "speed", type: "number", fallback: "1", uniform: "(time scale)", note: "Animation rate. 0 renders a single static frame." },
  { name: "width", type: "number", fallback: "800", uniform: "u_resolution.x", note: "Canvas width in pixels." },
  { name: "height", type: "number", fallback: "800", uniform: "u_resolution.y", note: "Canvas height in pixels." },
];
