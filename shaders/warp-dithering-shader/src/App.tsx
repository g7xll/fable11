		...
		<div className="min-h-screen bg-ink font-mono text-bone">
			...
			<section className="bg-blueprint border-b border-border/70">
				<div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
					...
					>
						The <span className="font-mono text-amber">shape</span> prop swaps
						the procedural field driving the dither. Every tile below is the
						exact same <span className="font-mono">DitheringShader</span>{" "}
						inheriting the console's current dither, colours and pixel size —
						tap one to send it to the hero.
					</SectionHeading>
					<ShapeLibrary
						params={params}
			...
			<section className="border-b border-border/70">
				<div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
					...
					>
						The <span className="font-mono text-amber">type</span> prop selects
						how the continuous field is thresholded into one bit. The ordered
						Bayer maps below are the literal threshold tables compiled into the
						shader — brighter cells flip on later as a region brightens.
					</SectionHeading>
					<DitherMatrices
						active={params.type}
					...
					<div className="mt-6 flex items-center gap-2 font-mono text-[11px] text-ash">
						...
						tip — drop <span className="text-amber">pxSize</span> on the console
						to shrink the cells and reveal the dithering detail.
					</div>
				</div>
			</section>
			...
			<section className="border-b border-border/70">
				<div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
					...
					>
						...
						<span className="font-mono text-amber">@/components/ui</span>,
						styles to{" "}
						<span className="font-mono text-amber">src/index.css</span> — both
						read from <span className="font-mono">components.json</span>.
					</SectionHeading>
					<IntegrationDocs />
				</div>
			</section>
