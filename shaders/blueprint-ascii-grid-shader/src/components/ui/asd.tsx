"use client";
// Verbatim drop-in from the brief. Two TS-only tweaks for a strict shadcn/Vite
// project: the unused default `React` import is dropped (modern JSX runtime), and
// the WebGL2 context is non-null-asserted so the hoisted helper closures below
// type-check. The runtime behaviour and shader are otherwise untouched.
