...
const BAYER: Record<Exclude<DitheringType, "random">, { size: number; data: number[] }> = {
        ...
        {data.map((v, i) => {
          ...
          return (
            <div
              ...
              style={{ backgroundColor: `rgba(255, 212, 0, ${0.06 + a * 0.9})` }}
            >
              <span
                className={cn(
                  "font-mono tabular-nums",
                  size === 8 ? "text-[7px]" : size === 4 ? "text-[10px]" : "text-base",
