...
/**
 * Liquid Crystal — an interactive WebGL interference-band shader.
 *
 * This is the verbatim prompt component ported to TypeScript: the raw-WebGL
 * management hook, the `ControlsPanel`, and the `InteractiveShader` quad. The
 * shader source, uniform wiring, and animation loop are unchanged from the
 * original JS; only types and an optional `onFrame` telemetry callback were
 * added so a host page can read live shader state (time, FPS, mouse-warp
 * center) straight off the render loop.
 */
