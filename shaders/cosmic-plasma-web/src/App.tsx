		...
		<main className="relative h-screen w-screen overflow-hidden bg-abyss text-white">
			...
			<footer className="absolute bottom-8 right-8 z-10 max-w-[230px] text-right">
				<p className="text-[11px] leading-relaxed text-mist">
					<span className="font-mono text-plasma">{"<PlasmaWeb/>"}</span>{" "}
					dropped verbatim into{" "}
					<span className="text-white/80">@/components/ui</span>. Shadcn
					structure · Tailwind · TypeScript · OGL.
				</p>
			</footer>
