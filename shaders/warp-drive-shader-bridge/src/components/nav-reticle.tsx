  ...
  return (
    ...
    >
      <svg viewBox="0 0 240 240" className="absolute inset-0 h-full w-full overflow-visible">
        {/* Outer rotating ring */}
        <g className="origin-center animate-reticle-spin" style={{ transformBox: "fill-box" }}>
          <circle cx="120" cy="120" r="112" fill="none" stroke="rgba(56,225,255,0.18)" strokeWidth="1" />
          <circle cx="120" cy="120" r="112" fill="none" stroke="rgba(56,225,255,0.55)" strokeWidth="1.5" strokeDasharray="2 30" />
        </g>

        {/* Counter-rotating inner ring */}
        <g className="origin-center animate-reticle-spin-rev" style={{ transformBox: "fill-box" }}>
          <circle cx="120" cy="120" r="100" fill="none" stroke="rgba(56,225,255,0.12)" strokeWidth="1" strokeDasharray="1 12" />
        </g>
        ...
        <g>
          {ticks.map((t, i) => (
            <line
              ...
              x2={t.x2}
              y2={t.y2}
              stroke={t.major ? "rgba(215,227,244,0.6)" : "rgba(111,126,152,0.4)"}
        ...
        {/* Crosshair */}
        <line x1="120" y1="34" x2="120" y2="62" stroke="rgba(56,225,255,0.5)" strokeWidth="1" />
        <line x1="120" y1="178" x2="120" y2="206" stroke="rgba(56,225,255,0.5)" strokeWidth="1" />
        <line x1="34" y1="120" x2="62" y2="120" stroke="rgba(56,225,255,0.5)" strokeWidth="1" />
        <line x1="178" y1="120" x2="206" y2="120" stroke="rgba(56,225,255,0.5)" strokeWidth="1" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-haze">Warp</span>
