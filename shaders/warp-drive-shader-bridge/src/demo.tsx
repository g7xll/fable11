...
export default function DemoOne() {
	...
	return (
		<div
			id="top"
			className="console-grain relative min-h-screen w-full bg-void"
		>
          ...
          verbatim shader without altering it. */}
			<div
				className="warp-streaks pointer-events-none fixed inset-0 z-[1] origin-center"
				aria-hidden
			/>
			<div
				className="warp-aura pointer-events-none fixed inset-0 z-[1]"
				aria-hidden
			/>
			<div
				className="canopy-vignette pointer-events-none fixed inset-0 z-[1]"
				aria-hidden
			/>
