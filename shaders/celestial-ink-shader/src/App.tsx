      ...
      <div className="relative h-full w-full overflow-hidden rounded-[2px] border border-line/40">
          ...
          {follow && (
            ...
            >
              <svg viewBox="0 0 136 136" className="h-full w-full">
                <g className="reticle-spin" style={{ transformOrigin: "68px 68px" }}>
                  <circle
                    cx="68"
                    cy="68"
                    r="58"
                ...
                />
                <line x1="68" y1="22" x2="68" y2="40" stroke="#ffe6b8" strokeOpacity="0.8" />
                <line x1="68" y1="96" x2="68" y2="114" stroke="#ffe6b8" strokeOpacity="0.8" />
                <line x1="22" y1="68" x2="40" y2="68" stroke="#ffe6b8" strokeOpacity="0.8" />
                <line x1="96" y1="68" x2="114" y2="68" stroke="#ffe6b8" strokeOpacity="0.8" />
        ...
        <div className="pointer-events-none absolute inset-0 z-30 flex flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
            ...
            >
              Move the cursor to disturb the ink — a ripple blooms where you read
              it. The field rotates and folds through six octaves of noise, drawn
              live on the GPU.
            </p>
          </div>
        ...
        <aside className="rise absolute left-5 top-1/2 z-30 hidden -translate-y-1/2 sm:left-8 lg:block">
          <div className="w-[208px] border-l border-line/50 pl-4">
            <div className="mb-3 flex items-center gap-2">
              <Activity className="h-3.5 w-3.5 text-gold/80" strokeWidth={1.5} />
