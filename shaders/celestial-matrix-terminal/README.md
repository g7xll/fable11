# Celestial Matrix Terminal

A shadcn-style integration of the brief's verbatim Three.js **Celestial Matrix**
shader — a blue→green field of "digital rain" bent around a cursor-driven
gravitational warp — reframed as **Meridian Station · Orbital Relay 9**: a
deep-space relay whose authentication console boots over the live transmission
feed.
