...
import { Flower2, Pause, Play, RotateCcw, Sparkles, Clock3 } from "lucide-react";
...
export default function App() {
  ...
  useEffect(() => {
    const id = window.setInterval(() => setDisplay({ ...telemetryRef.current }), 110);
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-ink font-body text-parchment">
      ...
      <div className="absolute inset-0">
        ...
        <div className="pointer-events-none absolute inset-0 plate-vignette" aria-hidden />
      </div>
      ...
      <div className="pointer-events-none relative z-10 flex h-full flex-col">
        ...
        <section className="flex flex-1 flex-col items-center justify-center px-6 text-center">
          ...
          <h1
            ...
            style={{
              animation: armed ? "title-bloom 1.2s cubic-bezier(0.16,1,0.3,1) 0.28s both" : "none",
          ...
          >
            Digital
            <br />
            <span className="italic text-pollen" style={{ fontVariationSettings: '"SOFT" 80, "opsz" 110' }}>
              Petals
            </span>
          </h1>
        ...
        >
          ...
          <Readout
            icon={<Sparkles className="h-3.5 w-3.5 text-petal" strokeWidth={1.8} />}
            label="Bloom index"
          ...
          />
          <Readout
            icon={<Clock3 className="h-3.5 w-3.5 text-iris" strokeWidth={1.8} />}
            label="Growth clock"
          ...
          />
          <Readout
            icon={<Flower2 className="h-3.5 w-3.5 text-pollen" strokeWidth={1.8} />}
            label="Render rate"
...
function PetalDial({
  ...
  return (
    <svg viewBox="0 0 100 100" className="h-14 w-14 shrink-0" aria-hidden>
      {/* gauge arc */}
      <circle cx="50" cy="50" r="42" fill="none" stroke="rgba(233,200,121,0.18)" strokeWidth="1" />
      ...
      <g ref={needleRef} style={{ transformOrigin: "50px 50px", transition: "transform 90ms linear" }}>
        <line x1="50" y1="50" x2="50" y2="16" stroke="#d61f7a" strokeWidth="2.4" strokeLinecap="round" />
      </g>
      {/* hub */}
      <circle cx="50" cy="50" r="4.5" fill="#120a14" stroke="#e9c879" strokeWidth="1.4" />
...
function PlateFrame({ armed }: { armed: boolean }) {
  ...
  const Sprig = ({ className, delay }: { className: string; delay: string }) => (
    <svg
      viewBox="0 0 60 60"
      className={cn(
      ...
      aria-hidden
    >
      <path d="M4 56 C 4 30, 18 18, 44 10" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" />
      <path d="M18 26 C 24 20, 30 20, 34 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" />
      <path d="M12 40 C 18 34, 24 34, 28 38" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" />
  ...
  return (
    <>
      ...
      <Sprig className="right-4 top-4 -scale-x-100 sm:right-6 sm:top-6" delay="0.28s" />
      <Sprig className="bottom-4 left-4 -scale-y-100 sm:bottom-6 sm:left-6" delay="0.36s" />
      <Sprig className="bottom-4 right-4 -scale-100 sm:bottom-6 sm:right-6" delay="0.44s" />
    </>
  );
}
