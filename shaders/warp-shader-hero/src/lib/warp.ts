...
export const WARP_CONTROLS: WarpControl[] = [
	...
	{ key: "distortion", label: "Distortion", min: 0, max: 1, step: 0.01, hint: "Domain warp applied to the pattern" },
	{ key: "proportion", label: "Proportion", min: 0, max: 1, step: 0.01, hint: "Balance between the colour bands" },
	{ key: "softness", label: "Softness", min: 0, max: 1, step: 0.01, hint: "Edge feathering of the shape" },
