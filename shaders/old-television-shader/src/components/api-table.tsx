...
export const PROP_ROWS: PropRow[] = [
	{
		...
		type: "string",
		def: '"#ffffff"',
		note: "Bright phosphor the snow mixes toward",
	},
	{
		name: "colorB",
		type: "string",
		def: '"#000000"',
		note: "Dark colour between scanlines",
	},
	{
		name: "waveIntensity",
		type: "number",
		def: "1",
		note: "Rolling-picture displacement amplitude",
	},
	{
		name: "grainIntensity",
		type: "number",
		def: "1",
		note: "Procedural snow / static strength",
	},
	{
		name: "brightnessPulse",
		type: "number",
		def: "1",
		note: "Slow brightness-breathing depth",
	},
	{
		name: "mouseInfluence",
		type: "number",
		def: "0.05",
		note: "Cursor → uMouse lerp factor (0–1)",
	},
	{
		name: "paused",
		type: "boolean",
		def: "false",
		note: "Freeze the animation clock on a held frame",
	},
	{
		name: "onSample",
		type: "(lum: number) => void",
		def: "—",
		note: "Per-frame centre-pixel luminance off the GPU",
	},
	{
		name: "sampleEveryMs",
		type: "number",
		def: "120",
		note: "Throttle for onSample, in ms",
	},
];
			...
			<div className="divide-y divide-cabinet-800/70">
				{rows.map((r, i) => (
					...
					>
						...
						<code className="font-mono text-[11px] text-bone-200/80">
							{r.def}
						</code>
