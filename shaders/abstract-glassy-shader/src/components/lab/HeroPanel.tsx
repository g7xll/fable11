...
const CHIPS = ["WebGL2 · 1 file", "Zero runtime deps", "Live uniforms", "CSS fallback"];
...
export function HeroPanel() {
  return (
    <div className="glass max-w-[600px] rounded-2xl p-6 sm:p-8">
      ...
      >
        Two signed-distance blobs, fused with a smooth union and lit by an exponential glow over a
        cosine spectrum. A single WebGL2 file that drops straight into{" "}
      ...
      >
        <CopyButton value={componentSource} label="Copy component" variant="solid" />
        <a
          href="#integration"
      ...
      >
        {CHIPS.map((c) => (
          <span key={c} className="font-mono text-[10.5px] uppercase tracking-[0.12em] text-muted-foreground">
