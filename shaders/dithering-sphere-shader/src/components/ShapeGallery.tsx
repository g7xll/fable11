		...
		>
			...
			<div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-ink via-ink/80 to-transparent px-4 pb-3 pt-8">
				<div className="flex items-center justify-between">
					<span className="font-display text-sm font-bold text-paper">{label}</span>
					{active && (
...
export function ShapeGallery({ params, onSelect }: ShapeGalleryProps) {
	return (
		<section id="shapes" className="relative border-t border-[var(--line)] px-5 py-24 sm:px-8">
				...
				<Reveal className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
					<div className="max-w-2xl">
						...
						<p className="mt-4 font-body text-paper-dim">
							The <code className="font-mono text-paper">shape</code> prop swaps the
							procedural field inside the same draw call. Every tile below runs your
							current dither, colours and pixel size — tap one to make it the hero.
						</p>
					</div>
				</Reveal>
