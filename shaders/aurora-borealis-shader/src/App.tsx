...
export default function App() {
	...
	const kp = useMemo(
		() => kpFromBrightness(display.brightness),
		[display.brightness],
	);
		...
		<main className="relative h-screen w-screen overflow-hidden font-body text-ice">
			...
			<div className="pointer-events-none relative z-10 flex h-full flex-col">
				...
				<section className="flex flex-1 flex-col items-center justify-center px-6 text-center">
					...
					<h1
						...
						style={{
							...
							textShadow:
								"0 0 52px rgba(63,240,168,0.32), 0 0 90px rgba(176,107,255,0.22)",
						}}
					>
						Aurora
						<br />
					...
					>
						An interactive WebGL shader. Sweep your cursor across the night to
						draw a solar-wind flare through the curtain — the Kp gauge reads the
						light you raise.
					</p>
				...
				>
					...
					<Readout
						icon={
							<Satellite className="h-3.5 w-3.5 text-ice" strokeWidth={1.8} />
						}
						label="Sky clock"
					...
					<Readout
						icon={
							<Compass className="h-3.5 w-3.5 text-violet" strokeWidth={1.8} />
						}
	...
	return (
		<div className="flex items-center gap-3 bg-[var(--glacier)]/70 px-4 py-3.5 backdrop-blur-md sm:px-6 sm:py-4">
			...
			<div className="min-w-0">
				<div className="font-mono text-[9px] uppercase tracking-[0.26em] text-frost">
					{label}
				</div>
				<div
					className={cn(
