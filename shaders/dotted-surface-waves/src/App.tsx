    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="relative flex flex-1 flex-col items-center justify-center px-6 text-center">
          ...
          >
            A breathing lattice of points, displaced by two crossing sine waves and
            rendered live with three.js. Flip the theme to swap the palette in real
            time.
          </p>
        </main>
...
function Stat({
  ...
  return (
    <span className="inline-flex items-center gap-2">
      ...
      <span className={isDark ? "text-zinc-300" : "text-zinc-800"}>{value}</span>
    </span>
  );
}
