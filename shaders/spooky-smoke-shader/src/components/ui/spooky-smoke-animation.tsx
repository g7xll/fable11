...
void main(){gl_Position=position;}`;
	...
	constructor(canvas: HTMLCanvasElement, fragmentSource: string) {
		this.canvas = canvas;
		// `preserveDrawingBuffer` keeps the rendered frame around after the
		// compositor swaps, which is required for the canvas to show up in
		// headless/offscreen captures (and for readPixels) on some GPU stacks.
		// The shader output is unchanged.
