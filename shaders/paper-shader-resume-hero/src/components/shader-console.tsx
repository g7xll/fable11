...
const SHAPE_THUMBS: Record<Shape, React.CSSProperties> = {
  simplex: { backgroundImage: `${DOTS}, linear-gradient(120deg, #2a0a1f, #000)` },
  warp: { backgroundImage: `${DOTS}, conic-gradient(from 90deg at 50% 50%, #3a0a28, #000, #3a0a28)` },
  dots: { backgroundImage: `radial-gradient(hsl(320,100%,70%) 45%, transparent 46%) 0 0 / 5px 5px, #000` },
  wave: { backgroundImage: `${DOTS}, repeating-linear-gradient(0deg, #2a0a1f 0 3px, #000 3px 7px)` },
  ripple: { backgroundImage: `${DOTS}, radial-gradient(circle at 50% 50%, #3a0a28, #000 70%)` },
  swirl: { backgroundImage: `${DOTS}, conic-gradient(from 0deg at 50% 50%, #000, #3a0a28, #000)` },
  sphere: { backgroundImage: `${DOTS}, radial-gradient(circle at 38% 35%, hsl(320,100%,70%), #2a0a1f 55%, #000 80%)` },
};
          ...
          <div>
            ...
            <div className="grid grid-cols-5 gap-1.5">
              {SWATCHES.map((s, i) => (
                ...
                >
                  <span className="absolute inset-0" style={{ background: s.back }} />
                  <span
            ...
            <div className="mt-2 font-mono text-[11px] text-ink-dim">
              ...
              {swatch.name} · front <span className="text-ink">{swatch.front}</span>
            </div>
          </div>
        </div>
      </div>
