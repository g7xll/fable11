    ...
    <div className="relative min-h-screen overflow-hidden flex">
      ...
      <div className="w-1/2 relative">
        <Dithering
          ...
          // Integration fix: the pasted component used shape="cat", which is not a
          // valid DitheringShape in @paper-design/shaders-react@0.0.76 (the union is
          // simplex | warp | dots | wave | ripple | swirl | sphere). It fails the
          // strict-TS build and renders an empty field at runtime, so it's corrected
          // to the package's own default shape, "sphere". See the integration notes
          // in the showcase (src/App.tsx) for the full rationale.
          shape="sphere"
          type="4x4"
          pxSize={3}
          offsetX={0}
