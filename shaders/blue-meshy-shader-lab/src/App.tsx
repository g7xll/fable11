...
const PARAMS = [
	{
		name: "ZOOM_FACTOR",
		value: "0.3",
		note: "Pattern scale — lower zooms further in.",
	},
	{ name: "BASE_WAVE_AMPLITUDE", value: "0.2", note: "Domain-warp strength." },
	{
		name: "RANDOM_WAVE_FACTOR",
		value: "0.15",
		note: "Noise-driven amplitude jitter over time.",
	},
	{ name: "WAVE_FREQUENCY", value: "4.0", note: "Sine frequency of the warp." },
	{ name: "TIME_FACTOR", value: "0.25", note: "Overall animation speed." },
	{
		name: "BASE_SWIRL_STRENGTH",
		value: "1.2",
		note: "Vortex strength near the centre.",
	},
	{ name: "SWIRL_TIME_MULT", value: "5.0", note: "Finer swirl timing." },
	{
		name: "NOISE_SWIRL_FACTOR",
		value: "0.2",
		note: "Extra swirl modulated by the noise field.",
	},
	{
		name: "FBM_OCTAVES",
		value: "10",
		note: "Fractal-noise octaves (must be an integer).",
	},
	{
		name: "seaColors[20]",
		value: "vec3[]",
		note: "20-step blue ramp; index 0 renders fully transparent.",
	},
];
	...
	return (
		<div className="relative min-h-screen bg-abyss-950 text-foam">
			...
			<main className="relative z-10">
					...
					<div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-24">
						...
						<div className="mt-5 flex items-start gap-3 rounded-xl border border-sea-500/20 bg-sea-500/[0.06] p-4 text-[13px] leading-relaxed text-foam/80">
							...
							<p>
								...
								as a full-bleed{" "}
								<span className="font-mono text-sea-200">min-h-screen</span>{" "}
								hero background behind a headline and CTA (the shipped pattern),
								or height-constrained as a section band. Mount one instance per
								view — each spins up its own GL context.
							</p>
						</div>
					</div>
				</section>
				...
				<section
					id="setup"
					className="scroll-mt-20 border-t border-hairline/50"
				>
					<div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-24">
						<SectionHeader
							index="01"
						...
						<div className="mt-8 grid gap-5 rounded-2xl border border-hairline/70 bg-abyss-900/60 p-6 sm:p-8 lg:grid-cols-[auto,1fr] lg:items-start lg:gap-8">
							...
							<div>
								<h3 className="font-display text-lg font-semibold text-foam">
									...
									<span className="font-mono text-sea-200">components/ui</span>{" "}
									matters
								</h3>
								<p className="mt-2 max-w-3xl text-[14px] leading-relaxed text-steel">
									...
									<span className="font-mono text-sea-200">@/lib/utils</span>.
									If your default component path is not{" "}
									<span className="font-mono text-sea-200">/components/ui</span>
