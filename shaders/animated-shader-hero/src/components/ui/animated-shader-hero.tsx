...
void main(){gl_Position=position;}`;
  ...
  useEffect(() => {
    ...
    rendererRef.current = new WebGLRenderer(canvas, Math.max(1, 0.5 * window.devicePixelRatio));
    pointersRef.current = new PointerHandler(canvas, Math.max(1, 0.5 * window.devicePixelRatio));
