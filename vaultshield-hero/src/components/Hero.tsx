  ...
  return (
    <main className="relative z-10 mx-auto w-full max-w-[1280px] px-5 sm:px-8">
      <div style={{ paddingTop: 'clamp(40px, 8vw, 72px)', maxWidth: 560 }}>
        ...
        >
          <Zap size={24} color="#192837" style={inlineIconStyle} aria-hidden="true" /> Lock Down
          Your Passwords{' '}
          <LockKeyhole size={24} color="#192837" style={inlineIconStyle} aria-hidden="true" /> with
          Ironclad Security{' '}
          <Fingerprint size={24} color="#192837" style={inlineIconStyle} aria-hidden="true" />
        </motion.h1>
