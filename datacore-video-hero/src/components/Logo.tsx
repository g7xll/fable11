...
export default function Logo() {
  return (
    <a href="/" className="flex items-center gap-2.5 transition-opacity hover:opacity-80" aria-label="Datacore home">
      ...
      <span className="font-manrope text-[17px] font-bold tracking-tight text-white">Datacore</span>
    </a>
  )
}
